...
Recurring invoices save time for ongoing client relationships. Set it once, and Lujo sends invoices automatically.
...
1. Go to [Invoices](https://app.lujo.app/invoices) → **Create invoice**
