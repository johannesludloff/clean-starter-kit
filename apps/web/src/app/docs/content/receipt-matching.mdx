...
description: How Lujo's AI automatically matches receipts to transactions and learns from your feedback.
section: inbox
order: 1
---

Lujo's inbox captures receipts and invoices, then uses AI to match them to your bank transactions. No more manual filing or searching for receipts at tax time.
...
Lujo's matching improves over time through several learning mechanisms:
...
## Getting receipts into Lujo

### Email forwarding

Every Lujo account has a unique inbox email address:
...
4. Lujo scans for receipts and invoices automatically
...
1. Connect your Slack workspace in [Inbox → Settings](https://app.lujo.app/inbox/settings)
2. Share any file to the connected channel
3. It appears in your Lujo inbox automatically
...
1. Go to [Inbox](https://app.lujo.app/inbox)
...
The purchase might be on an account you haven't connected. Check your connected accounts in [Settings → Accounts](https://app.lujo.app/settings/accounts).
...
- Connected email access is read-only—Lujo can't send emails
