...
The Vault is your centralized document storage in Lujo. Store contracts, receipts, statements, and any business documents—all searchable and organized.

## What is the Vault

The Vault is a secure file storage system built into Lujo. Unlike your inbox (which captures receipts for transaction matching), the Vault is for any document you want to keep:
...
1. Go to [Vault](https://app.lujo.app/vault)
...
Your storage limit depends on your plan. Check your current usage in [Settings → Billing](https://app.lujo.app/settings/billing).
