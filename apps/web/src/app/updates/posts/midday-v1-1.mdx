...
We're excited to release Lujo v1.1—our biggest update yet! This release brings intelligent tax automation, a native desktop app, public APIs, and dozens of improvements that make managing your business finances faster and more intuitive than ever.
...
#### Tax assistant
<br />
Say goodbye to manual tax calculations. Lujo now automatically extracts tax rates and types from your uploaded receipts and applies them to transactions, making reconciliation fast and accurate. Plus, get instant tax insights with our AI assistant:
...
Lujo is now just one keystroke away with our new native desktop app. Access your financial data instantly and search across your entire business.

- **Instant access:** Launch Lujo with a simple keyboard shortcut from anywhere on your computer—no more hunting through browser tabs
...
- **Always at your fingertips:** Whether you're in a meeting, on a call, or working in another app, Lujo is ready when you need it
...
Build your own integrations and automate your workflows with Lujo's new public API and SDKs. Connect Lujo to your existing tools, create custom dashboards, or automate repetitive tasks.

- **RESTful API:** Access your Lujo data securely and reliably at [api.midday.ai](https://api.midday.ai)
...
<br />
We've upgraded our infrastructure, added replicas in the US, and reworked how we read and write data under the hood. As a result, Lujo is now ~70% faster in the US. These changes lay the foundation for an even better experience, especially with the upcoming Assistant and Mobile App.
...
We're already working on the next wave of enhancements to make Lujo even more indispensable:
...
- **Webhooks:** Get real-time notifications and trigger workflows in your own systems when key events happen in Lujo
