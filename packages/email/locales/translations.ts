  ...
  switch (locale) {
    case "en":
      return {
        ...
        "invite.subject": `${params?.invitedByName} invited you to the ${params?.teamName} team on Lujo`,
        "invite.preview": `Join ${params?.teamName} on Lujo`,
        "invite.title1": "Join",
        "invite.title2": "on",
    ...
    case "sv":
      return {
        ...
        "invite.subject": `${params?.invitedByName} bjöd in dig till ${params?.teamName} på Lujo`,
        "invite.preview": `Gå med i ${params?.teamName} på Lujo`,
