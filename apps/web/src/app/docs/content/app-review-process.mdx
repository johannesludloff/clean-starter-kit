...
description: Get your OAuth app verified and listed in the Lujo app directory.
section: developer
order: 5
---

Once your OAuth app is working, you can submit it for review. Verified apps display a trust badge and can be listed in the Lujo app directory for users to discover.

## Why get verified?

### For users

- **Trust badge**: Verified apps show users that Lujo has reviewed the app
...
- **App directory listing**: Reach Lujo's user base
- **Partnership opportunities**: Connect with the Lujo team
...
- Apps work fully
- Users see a warning: "This app hasn't been verified by Lujo yet"
...
- [ ] App works with different Lujo accounts
...
After approval, you can opt to list your app in the Lujo app directory:
...
- Don't include "Lujo" unless you have permission
- Avoid misleading names that imply official Lujo features
...
- **Email**: [support@lujo.app](mailto:support@lujo.app)
- **Discord**: [go.lujo.app/discord](https://go.lujo.app/discord)
