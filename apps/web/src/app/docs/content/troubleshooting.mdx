...
Quick solutions to common issues you might encounter with Lujo.
...
1. Check the connection is still active in [Inbox Settings](https://app.lujo.app/inbox/settings)
...
1. Verify Stripe is connected in [Invoice Settings](https://app.lujo.app/settings/invoice)
...
1. Go to [Settings → Billing](https://app.lujo.app/settings/billing)
...
1. **Email**: [support@lujo.app](mailto:support@lujo.app)
