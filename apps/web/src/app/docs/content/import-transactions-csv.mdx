...
Most bank exports work directly. Lujo maps common formats automatically.
...
4. Map columns to Lujo fields
5. Review the preview
6. Confirm import

## Column mapping

If Lujo doesn't recognize your columns automatically:

1. Match each CSV column to a Lujo field
...
- Lujo checks for duplicates based on date, amount, and description
