...
Customers in Lujo store the information you need for invoicing and tracking work.

## Add a customer

1. Go to [Customers](https://app.lujo.app/customers)
...
Lujo can automatically enrich customer profiles:
