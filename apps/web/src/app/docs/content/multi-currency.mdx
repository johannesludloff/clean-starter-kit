...
description: How Lujo handles multiple currencies and exchange rates.
section: banking
order: 7
---

Lujo supports businesses operating in multiple currencies. Connect accounts in different currencies, track international transactions, and see unified reports in your base currency.
...
1. Go to [Settings → Accounts](https://app.lujo.app/settings/accounts)
...
You can connect bank accounts in any currency Lujo supports.
...
Lujo uses market exchange rates to convert currencies.
...
Lujo uses reliable market rates updated daily. Rates are for display purposes and may differ slightly from your bank's rates.
...
For tax purposes, you may need to track original currency amounts. Lujo stores both the original and converted amounts for every transaction.

## Supported currencies

Lujo supports all major world currencies including:
