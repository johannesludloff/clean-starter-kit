...
description: Use the Lujo assistant in your own tools via MCP.
section: assistant
order: 2
---

The Lujo assistant is available through the Model Context Protocol (MCP), letting you query your financial data from AI tools like Claude Desktop, Cursor, ChatGPT, and Raycast.

## What is MCP?

Model Context Protocol (MCP) is an open standard for connecting AI assistants to external data sources. Instead of copying and pasting data, MCP lets AI tools query your Lujo data directly and securely.
...
1. Go to [Settings → Developer](https://app.lujo.app/settings/developer)
...
Add Lujo to your Claude Desktop configuration.
...
After saving, restart Claude Desktop. You should see Lujo in your available tools.
...
Use Lujo data while coding in Cursor.
...
Use Lujo with ChatGPT via custom GPTs or plugins.

### Custom GPT approach

1. Create a Custom GPT in ChatGPT
2. Add actions that call the Lujo API
3. Configure authentication with your API key

### Configuration

Use the Lujo API endpoints with your API key in the Authorization header:
...
Access Lujo from Raycast on Mac.

### Install the extension

1. Open Raycast
2. Search for "Lujo" in the Store
3. Install the extension

### Configure

1. Open Raycast preferences
2. Find the Lujo extension
3. Enter your API key

### Use it

Trigger Raycast and use Lujo commands to query your financial data.

---

## Available tools

The MCP integration provides access to all your Lujo data:
...
>
> **Assistant**: Based on your Lujo data:
> - Cash balance: $45,230
