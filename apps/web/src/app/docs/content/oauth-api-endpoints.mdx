...
description: Technical reference for Lujo OAuth 2.0 endpoints.
section: developer
order: 4
---

Complete technical reference for Lujo's OAuth 2.0 implementation. These endpoints follow the [OAuth 2.0 RFC 6749](https://tools.ietf.org/html/rfc6749) and [PKCE RFC 7636](https://tools.ietf.org/html/rfc7636) specifications.

## Base URLs

| Environment | URL |
|-------------|-----|
| Authorization | `https://app.lujo.app/oauth` |
| Token & API | `https://api.lujo.app/v1` |
...
```
GET https://app.lujo.app/oauth/authorize
```
...
```
POST https://api.lujo.app/v1/oauth/token
```
...
```
POST https://api.lujo.app/v1/oauth/revoke
```
...
Once you have an access token, use the Lujo SDK for API requests:
