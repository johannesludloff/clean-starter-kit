...
description: How Lujo calculates your financial metrics and what affects each number.
section: reports
order: 0
---

Lujo gives you real-time visibility into your business finances. This guide explains how each metric is calculated and what factors affect them.
...
Credit card "available balance" isn't your money—it's borrowed money you'll need to pay back. Lujo shows only the cash you actually have.

### Multi-currency accounts

If you have accounts in different currencies, Lujo converts them to your base currency using current exchange rates. Set your base currency in [Settings](https://app.lujo.app/settings).
...
Lujo calculates averages over 3-6 months to smooth out one-time spikes.
...
Lujo excludes credit card payments from burn rate automatically. The actual expenses on your credit card still count.
...
Lujo shows net profit (all expenses included). For gross profit (revenue minus only cost of goods sold), filter your reports to exclude operating expenses.
...
Unlike simple trend projections, Lujo builds forecasts from known revenue sources:
